...
class ChessboardPredictor(object):
  ...
  def __init__(self, frozen_graph_path='/Users/artistutsav/Documents/my-server/chess_helper_bot/resources/tensorflow_chessbot-chessfenbot/saved_models/frozen_graph.pb'):
